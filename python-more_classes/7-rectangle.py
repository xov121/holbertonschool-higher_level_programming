...
a class attribute for the print symbol,
methods to calculate its area and perimeter,
a method to represent the rectangle using the print symbol,
...
class Rectangle:
    ...
    def __str__(self):
        ...
        Represents the rectangle with rows of print_symbol characters.
